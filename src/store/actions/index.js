...
import {sendMsg, sendFileMsg, sendFileMsgPhoto, sendMsgReceipt, sendRobotMsg, revocateMsg, getHistoryMsgs, resetNoMoreHistoryMsgs, continueRobotMsg} from './msgs'
...
function connectNim ({state, commit, dispatch}, obj) {
  ...
  if (!state.nim || force) {
    let loginInfo = {
      ...
      // uid: "047e07dc68dd43b8b9ba30ceb1adbebb",
      // sdktoken: "a9ad416637cb314e603788bc25701372",
    }
