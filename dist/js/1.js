...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      icon_nodata: _configs2.default.resourceUrl + 'im/bg_nodata@3x.png',
      deleteIdServer: '',
      title: '通知',
      msgList: '',
      sendTime: '',
